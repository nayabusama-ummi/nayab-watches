...
export const PRODUCTS: Product[] = [
  {
    ...
    specs: {
      ...
      jewels: 28,
      bracelet: 'Hand-stitched patinated leather'
    }
  },
  {
    id: 'meridian-41',
    ...
    isHero: true,
    category: 'mens',
    description: 'The contemporary titanium flagship of NAYAB. Forged in ultra-light titanium with an integrated tapering bracelet, textured midnight-blue dial, and micro-rotor automatic calibre.',
    ...
    specs: {
      caseDiameter: '41 mm',
      thickness: '9.8 mm',
      caseMaterial: 'Titanium with satin and hand-polished facets',
      dial: 'Textured Midnight-Blue Clous de Paris with luminescent indices',
      hands: 'Skeletonized titanium hands with luminous coating',
      ...
      jewels: 32,
      bracelet: 'Integrated titanium tapered bracelet with hidden micro-adjustment clasp'
    }
  },
  {
    id: 'noor-32',
  ...
  },
  {
    ...
    specs: {
      caseDiameter: '42 mm',
      thickness: '12.4 mm',
      caseMaterial: 'Marine-grade Steel with Ceramic Bezel',
